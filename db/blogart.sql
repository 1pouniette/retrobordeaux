...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 29 mars 2019 à 08:25
...
('', '', ''),
('DF56K', 'Grandes figures littéraires', 'FRAN01'),
('DVM1PL', 'Secret', 'FRAN01'),
('F67AS9', 'Expérience 3.0', 'FRAN01'),
('GHPLQ1', 'Handicap', 'FRAN01'),
('H23KK1', 'Intelligence collective', 'FRAN01'),
('JH39M2', 'Yik Yak', 'FRAN01'),
('JU5M21', 'Recherche vocale', 'FRAN01'),
('MG8Q0V', 'Stories', 'FRAN01'),
('QR5P09', 'Happy hours', 'FRAN01'),
('SF6QQ3', 'Shots', 'FRAN01'),
('VG32QM', 'Chatbot et IA', 'FRAN01'),
('WM44GQ', 'We heart it', 'FRAN01'),
('YH40QL', 'Histoire médiévale', 'FRAN01'),
('ZH0LO4', 'Tik Tak', 'FRAN01');
...
('', '', ''),
('ALL041', 'Allemand(e)', 'Langue allemande'),
('ANGL01', 'Anglais(e)', 'Langue anglaise'),
('BULG21', 'Bulgare', 'Langue bulgare'),
('FRAN01', 'Français(e)', 'Langue française'),
('ITAL11', 'Italien(ne)', 'Langue italienne'),
('SPAIN01', 'Espagnol(e)', 'Langue espagnole'),
('URS98', 'Ukrainien(ne)', 'Langue ukrainienne'),
('URS99', 'Russe', 'Langue russe');
